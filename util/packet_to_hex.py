...
def extract_from_packet_as_bytes(x, start=0, end=0):
    """
        Extract from the packet from index starting at start, until index ending at end
        Return it in the wireshark format as string. Such that it will be accepted by the FNV128A hash.
        :param start:
        :param end:
        :param x:
        :return:
